...
async def summarize(req: SummarizationRequest):
    ...
    # --- Prompt construction ---
    prompt = (
        "You are an expert newsletter summarizer and content curator.\n"
        "Your task is to read and distill news from multiple newsletters, then:\n"
        "\n"
        ...
        "      \"name\": \"Theme Name\",\n"
        "      \"items\": [\n"
        "        { \"summary\": \"Multi-sentence description.\", \"source\": \"Source Name\" },\n"
        "        ...\n"
        "      ]\n"
        "    }\n"
        "  ]\n"
        "}\n"
        "\n"
        "Do not repeat content between TL;DR and detailed stories. Do not include any explanations outside the JSON."
    )
